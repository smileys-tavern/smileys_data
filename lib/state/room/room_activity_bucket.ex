defmodule SmileysData.State.Room.ActivityBucket do
  ...
  """
  def increment_room_bucket_activity!(room_bucket, %Activity{subs: new_subs, new_posts: new_new_posts, hot_posts: new_hot_posts}) do
    Agent.get_and_update(room_bucket, fn %Activity{subs: subs, new_posts: new_posts, hot_posts: hot_posts} ->
    	new_activity = %Activity{subs: subs + new_subs, new_posts: new_posts + new_new_posts, hot_posts: hot_posts + new_hot_posts}

defmodule SmileysData.State.Room.ActivityRegistry do
  @moduledoc """
  ...
  defp set_activity_elimination_timer(room_name, %Activity{subs: subs, new_posts: new_posts, hot_posts: hot_posts}) do
    activity_reversed = %Activity{subs: subs * -1, new_posts: new_posts * -1, hot_posts: hot_posts * -1}
